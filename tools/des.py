...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='A script to calculate des_info version of dataset')
    parser.add_argument('--dataset_dir', default='', help='path to des_dataset')
    parser.add_argument('--fname', default=f'{bac}.h5', help='name of output file name, name it xxx.h5')
    args = parser.parse_args()
    datadir = args.dataset_dir
    fname = args.fname
    outdir = ''
    processor = DesProcessor(label_cols=['Labels'])
    ...
    processor.generate_normed_data(outdir,fname)
