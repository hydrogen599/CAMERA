...
def doit(ind,sequence_list):
    ...
    gc.collect()
    # 保存生成的结构化数
    writeDataToExcleFile(sequences, peptides_descriptors, ('/home/peptide/sequence_generate/structured_data/7_peptide_7_' + str(ind) + '.csv'))
...
if __name__ == "__main__":
    file_path = "/home/peptide/sequence_generate/7_peptide_result/7_peptide_rule_7.txt" # 2657205/166075
    print(file_path)
